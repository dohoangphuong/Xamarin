...
namespace Chapter07._1_NativeShared.Droid
{
	[Activity (Label = "Demo Native Shared.Droid", MainLauncher = true, Icon = "@drawable/icon")]
	public class MainActivity : Activity
	{
        ...
        private async Task<JsonValue> FetchWeatherAsync(string url)
        {
            ...
            request.Method = "GET";
            Log.Warn("aaaaaaaaaaaaaaaaaaaaa", request.ToString());
            // Send the request to the server and wait for the response:
            using (WebResponse response = await request.GetResponseAsync().ConfigureAwait(false))
            {
                Log.Warn("aaaaaaaaaaaaaaaaaaaaa", "A21");
            ...
            Log.Warn("aaaaaaaaaaaaaaaaaaaaa", "A23");
        }
        ...
        {
            Log.Warn("aaaaaaaaaaaaaaaaaaaaa", "A031");
            ...
            Log.Warn("aaaaaaaaaaaaaaaaaaaaa", "A032");
